...
function createBabelInputPluginFactory(customCallback = returnObject) {
  ...
  return pluginOptions => {
    ...
    if (parallel) {
      ...
      workerPool = new WorkerPool(new URL('./worker.js', (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('index.js', document.baseURI).href))).pathname);
    }
    const helpersFilter = {
